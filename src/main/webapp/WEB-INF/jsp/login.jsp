...
<meta charset="utf-8" />
<!-- <link rel="icon" type="image/png" href="images/MansarIcon.png" /> -->
<title>Login Page - JNB Technology</title>
					...
					<div class="login-container">
						<div class="center">
							<h1>
								...
								<span class="red">&copy; JNB</span> <span class="white"
									id="id-text2">Technology</span>
							</h1>
							...
							<div id="login-box"
								...
								<div class="widget-body">
									<div class="widget-main">
										...
										<form id="Login" method="POST" action="CheckLogin.html">
											<fieldset>
