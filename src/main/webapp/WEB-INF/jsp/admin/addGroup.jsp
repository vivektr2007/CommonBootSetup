							...
							<form class="form-horizontal" role="form" method="post" action="addGroupSubmit.html">
								<div class="form-group">
									...
									<div class="col-sm-9">
										...
										<input placeholder="Enter group name" type="text" class="col-xs-10 col-sm-5" tabindex="1" name="groupName" size="200" value="${groupBean.groupName }" required>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<textarea placeholder="Enter group description" class="col-xs-10 col-sm-5" tabindex="2" name="groupDesc" required>${groupBean.groupDesc }</textarea>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<select name="rolePk" required tabindex="3" class="col-xs-10 col-sm-5">
												...
												<div class="checkbox">
													<label>
														<c:if test="${fn:contains(groupBean.userPks, userBean.pk)}">
															<input type="checkbox" class="ace" name="userPks" value="${userBean.pk }" checked="checked"/>
														</c:if>
														<c:if test="${!fn:contains(groupBean.userPks, userBean.pk)}">
															<input type="checkbox" class="ace" name="userPks" value="${userBean.pk }"/>
														</c:if>
